    ...
    <div class="container">
      <div class="search-panel animated-med fadeInUp">
        <div class="search-panel-top">
          ...
          >Subscription Setup</div>
        </div>
        <div class="search-panel-content">
          <form class="form" @submit.prevent="submitForm">
            <div class="tab-container">
              <div class="tab" :class="{'active':tab == 0}">
                <i v-if="tab > 0" class="fa fa-check-circle animated zoomIn"></i> Basic Information
              ...
              <div class="tab" :class="{'active':tab == 1}">
                <i v-if="tab > 1" class="fa fa-check-circle animated zoomIn"></i> Payment Details
                <div class="bottom-bar"></div>
              </div>
              <div class="tab-divider">
                <i class="fal fa-angle-right"></i>
              ...
              <div class="tab" :class="{'active':tab == 2}">
                <i v-if="tab > 2" class="fa fa-check-circle animated zoomIn"></i> Confirmation
                <div class="bottom-bar"></div>
              </div>
            </div>
            <transition
              ...
              mode="out-in"
            >
              <div :key="0" v-if="tab == 0" class="result-content animated-fast">
                <div v-for="(item, i) in items" :key="i" class="result-content-item">
                ...
                <div class="button-container">
                  <div @click="createUser" class="modal-btn confirm">
                ...
                >
                  ...
                  <div class="result-content-item-value">
                    ...
                    <span v-else>
                      ...
                      <span @click="switchPlan" style="color:#3080e8; cursor:pointer">(switch)</span>
                    </span>
                  </div>
                </div>
                <div
...
export default {
  ...
  mounted() {
    if (
      this.$store.state.userStore.user.id != null &&
      this.$store.state.userStore.user.is_active != false
    ) {
    ...
    if (
      this.$store.state.userStore.user.id != null &&
      this.$store.state.userStore.user.sub_id == null
    ) {
      this.$router.push("/activate_sub?sub=m");
    }
  },
  methods: {
    switchPlan() {
      if (this.$route.query.sub == "m") {
        this.$route.query.sub = "y";
      }
      if (this.$route.query.sub == "y") {
        this.$route.query.sub = "m";
      }
    },
    createUser() {
      this.isLoading = true;
